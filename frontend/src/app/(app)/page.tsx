  ...
  const widgets = useMemo<WidgetDef[]>(() => {
    const w: WidgetDef[] = [
      {
        ...
        defaultLayout: { x: 0, y: 0, w: 2, h: 3, minW: 1, minH: 2 },
        render: () => (
          <>
      ...
      },
      {
        id: 'hosts',
        title: 'Hosts',
        defaultLayout: { x: 0, y: 3, w: 1, h: 3, minW: 1, minH: 2 },
        render: () => (
          <>
            <h3 className="text-sm font-medium text-slate-300 mb-3 flex items-center gap-2">
      ...
      },
      {
        id: 'integrations',
        title: 'Integrations',
        defaultLayout: { x: 1, y: 3, w: 1, h: 3, minW: 1, minH: 2 },
        render: () => (
          <>
            <h3 className="text-sm font-medium text-slate-300 mb-3 flex items-center gap-2">
      ...
      },
      {
        id: 'syslog-rate',
        title: 'Syslog Rate',
        defaultLayout: { x: 0, y: 6, w: 1, h: 3, minW: 1, minH: 2 },
        render: () => (
          <>
            <h3 className="text-sm font-medium text-slate-300 mb-3 flex items-center gap-2">
            ...
            {isLoading || !data?.syslog_stats?.rate_data ? (
              ...
              <EChart
                ...
                option={{
                  ...
                  legend: { show: false },
                  xAxis: { type: 'category', data: data.syslog_stats.rate_data.labels },
                  yAxis: { type: 'value' },
                  series: [
      ...
      },
      {
        ...
        defaultLayout: { x: 1, y: 6, w: 1, h: 3, minW: 1, minH: 2 },
        render: () => (
          <>
            <h3 className="text-sm font-medium text-slate-300 mb-3 flex items-center gap-2">
    ...
    if (data?.storage_pools?.length) {
      w.push({
        id: 'storage',
        title: 'Storage',
        defaultLayout: { x: 0, y: 9, w: 1, h: 3, minW: 1, minH: 2 },
        render: () => (
          <>
            <h3 className="text-sm font-medium text-slate-300 mb-3 flex items-center gap-2">
                  ...
                  <div className="h-2 rounded-full bg-white/[0.06] overflow-hidden">
                    <div
                      ...
                      style={{
                        ...
                        background: pool.used_pct >= 90 ? '#F87171' : pool.used_pct >= 75 ? '#FBBF24' : '#34D399',
                      }}
                    />
                  </div>
                </div>
    ...
    if (data?.speedtest_data) {
      w.push({
        id: 'speedtest',
        title: 'Speedtest',
        defaultLayout: { x: 1, y: 9, w: 1, h: 2, minW: 1, minH: 2 },
        render: () => (
          <>
            <h3 className="text-sm font-medium text-slate-300 mb-3 flex items-center gap-2">
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <StatCard icon={Wrench} label="Maintenance" value={maintCount} color="text-amber-400" loading={isLoading} />
      </div>
